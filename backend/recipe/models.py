...
class LikedRecipes(models.Model):
    ...
    does_liked = models.CharField(max_length=30, choices=LikeType.choices, default=LikeType.NO_OPINION)
...
class Recipe(models.Model):
    ...
    recipe_rating = models.DecimalField(max_digits=7, decimal_places=2, null=True, blank=True)
