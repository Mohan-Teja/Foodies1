...
class ListRecipeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Recipe
        fields = ['id', 'recipe_title', 'recipe_slug', 'recipe_rating', 'recipe_numReviews', 'prep_time', 'meal_type', 'food_type', 'cuisine_type', 'recipe_main_photo', 'recipe_photo1', 'recipe_photo2', 'recipe_photo3']
